<?php
/**
 * Unit tests for (some of) question/type/code/questiontype.php.
 *
...
class question_code_qtype_test extends UnitTestCase {
    public static $includecoverage = array('question/type/questiontype.php', 'question/type/code/questiontype.php');
    var $qtype;

    function setUp() {
        $this->qtype = new question_code_qtype();
    }
    ...
    function test_name() {
        $this->assertEqual($this->qtype->name(), 'code');
    }
